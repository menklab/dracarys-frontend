...
export default function Terms() {
  return (
    <Box sx={{ textAlign: "center", padding: "2% 10%" }}>
      ...
      <p>
        <span>
          <span>
            This website is operated by Menklab. Throughout the site, the terms “we”, “us” and “our” refer to Menklab.
            Menklab offers this website, including all information, tools and Services available from this site to you,
      ...
      <p>
        <span>
          <span>
            ...
            Privacy Policy, please see [LINK TO PRIVACY POLICY]
          </span>
        </span>
      </p>
      ...
      <p>
        <span>
          <span>
            In no case shall Menklab, our directors, officers, employees, affiliates, agents, contractors, interns,
      ...
      <p>
        <span>
          <span>
            You agree to indemnify, defend and hold harmless Menklab and our parent, subsidiaries, affiliates, partners,
      ...
      <p>
        <span>
          <span>You can review the most current version of the Terms of Service at any time at this page.</span>
        </span>
      </p>
      ...
      <p>
        <span>
          <span>Questions about the Terms of Service should be sent to us at </span>
        </span>
        <a href="mailto:Dasha.Malakhova@menklab.com" style={{ color: "white" }}>
          <span>
            <span>
              <u>Dasha.Malakhova@menklab.com</u>
            </span>
          </span>
        </a>
        <span>
      ...
      <p>
        <span>
          <span>Grand Rapids, 6326 E Fulton St, Ada, MI 49301, United States</span>
        </span>
      </p>
    </Box>
  );
